package com.wordsfairy.filesync.store
...
fun String.decodeString(defaultValue: String = ""): String {
    return DataStoreUtils.readStringData(this, defaultValue)
}
fun String.encodeString(value: String = "") {
    DataStoreUtils.saveSyncStringData(this, value)
}
